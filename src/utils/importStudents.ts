          ...
          rawRows.forEach((row: any) => {
            ...
            if (!studentMap.has(nie)) {
              studentMap.set(nie, {
                ...
                dui_responsable: row['DUI'] || row['DUI RESPONSABLE'] || row['DUI ENCARGADO'] || row['DUI_ENCARGADO'] || '',
                telefono_responsable: row['TELEFONO'] || row['TELÉFONO'] || row['CELULAR'] || row['CONTACTO'] || '',
